public class Sorting2{
	public static void main(String[] args){
	    ...
	    printArray("\nArray in descendingOrder: ", array);
	}
    ...
    //method that takes the elements from the array and puts them into descending order
	public static void descendingOrder(int[] array){
        
        //nested for loop that akes use of a bubble sort algorithm to place the values from biggest to smallest
        for(int i = 0; i < array.length - 1; i++){
         	for(int j = 0; j < array.length - 1 - i; j++){
                
                //if statement that checks if the adjacent value is greater, if it is it gets swapped
